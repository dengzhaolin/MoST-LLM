...
from model_tune import ModalMoE

from model_tune import LLMFineTuner
...
def traintest_model(dataset):
    ...
    optimizer = optim.Adam([
        ...
        {'params': prediction_head.parameters(), 'lr': 0.001},
    #{'params': pre_trained_vae.parameters(), 'lr': 0.001}
    ])
    ...
    for epoch in range(nb_epoch):
        ...
        for j, x_batch in enumerate(gen_batch(dataset.get_data('train'), args.batch_size, dynamic_batch=True, shuffle=True)):
            ...
            masked_data, mask = apply_mask_single(x, mask_type="agnostic", temporal_hours=temporal_hours,
...
def get_model():
    ...
    pre_trained_model_path = "/data/dzl2023/MoSSL/ST_facted/multi_facted/MODEL/MultiFactedVAE.h5"
    ...
    pre_trained_signal_path="/data/dzl2023/MoSSL/ST_facted/MODEL/SignalFactedVAE.h5"
...
parser.add_argument("--steps", default=[30, 60, 100], type=eval, help="steps")
