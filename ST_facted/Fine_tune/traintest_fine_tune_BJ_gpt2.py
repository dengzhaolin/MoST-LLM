...
from model_tune_gpt2 import ModalMoE



from model_tune_gpt2 import LLMFineTuner ,Prediction
...
model_name = "/data/dzl2023/LLM-Factory/GPT2"
device_ids=[6]
...
def traintest_model(dataset):
    ...
    optimizer = optim.Adam([
        {'params': fine_tuner.parameters(), 'lr': 0.001},
        {'params': prediction_head.parameters(), 'lr': 0.0001},
...
def get_model():
    ...
    pre_trained_signal_path="/data/dzl2023/MoSSL/ST_facted/signal_facted/MODEL/SignalFactedVAE/SignalFactedVAE_BJ.h5"
