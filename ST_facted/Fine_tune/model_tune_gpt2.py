...
class LLMFineTuner(nn.Module):
    def __init__(self,model_name, tokenizer_name, device='cuda'):
        ...
        self.model = self.gpt2 = GPT2Model.from_pretrained(
    ...
    def forward(self, inputs_embeds):
        ...
        outputs = self.model(inputs_embeds=inputs_embeds).last_hidden_state
...
class ModalMoE(nn.Module):
    def __init__(self, in_channels=192, num_modals=4, num_experts=4):
