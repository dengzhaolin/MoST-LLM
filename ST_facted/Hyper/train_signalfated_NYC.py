...
def get_model():
    ...
    pre_trained_model_path = "/data/dzl2023/MoSSL/ST_facted/Hyper/MODEL/MultiFactedVAE_Hyper/MultiFactedVAE_NYC_0.5.h5"
...
def traintest_model(dataset):
    model = get_model()
    file_name = "SignalFactedVAE_{}_{}".format(args.data_name,0.5)
