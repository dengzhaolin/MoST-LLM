...
from model_tune_2 import LLMFineTuner_8 ,Prediction
...
def get_model():
    fine_tuner = LLMFineTuner_8(model_name, model_name, device).to(device)
    ...
    pre_trained_signal_path="/data/dzl2023/MoSSL/ST_facted/Hyper/MODEL/SignalFactedVAE_Hyper/SignalFactedVAE_NYC_0.5.h5"
