...
def get_model():
    ...
    pre_trained_model_path = "/data/dzl2023/MoSSL/ST_facted/Abilition/MODEL/MultiFactedVAE/MultiFactedVAE_NoSpatialMask.h5"
...
def traintest_model(dataset):
    model = get_model()
    file_name = "SignalFactedVAE_{}_NO_SpatialMask".format(args.data_name)
    ...
    for epoch in range(nb_epoch):
        ...
        for j, x_batch in enumerate(
            ...
            masked_data, mask = apply_rand_mask(x, mask_type="temporal", temporal_hours=temporal_hours,
...
parser.add_argument('--cuda', default = 2, type=int, help='cuda name')
