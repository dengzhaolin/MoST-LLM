...
def get_model():
    ...
    pre_trained_model_path = "/data/dzl2023/MoSSL/ST_facted/Abilition/MODEL/MultiFactedVAE/MultiFactedVAE_NoTemporalMask.h5"
...
def traintest_model(dataset):
    model = get_model()
    file_name = "SignalFactedVAE_{}_No_TemporalMask".format(args.data_name)
    ...
    for epoch in range(nb_epoch):
        ...
        for j, x_batch in enumerate(
            ...
            masked_data, mask = apply_rand_mask(x, mask_type="spatial", temporal_hours=temporal_hours,
